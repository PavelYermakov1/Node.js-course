window.onload = function () {
  const germanCarsString =
    '[{"car":"BMW","model":"5-series e39"},{"car":"Volkswagen","model":"Golf MK 3"}]';
  const japanCarsString =
    '[{"car":"Honda","model":"Civic (5G)"},{"car":"Nissan","model":"Silvia (S14)"}]';
